...
notebook_content = {
    "cells": [
        ...
        },
        {
            ...
            "outputs": [],
            "source": [
                "# 1. Clone repository or pull latest updates (foolproof path handling)\n",
                "import os\n",
                "from pathlib import Path\n",
                "\n",
                "repo_dir = Path('/kaggle/working/MLchLg')\n",
...
output_path = Path("d:/ml challenge/notebooks/kaggle_gpu_pipeline.ipynb")
